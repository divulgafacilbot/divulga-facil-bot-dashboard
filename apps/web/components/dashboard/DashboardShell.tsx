    ...
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-text-main)]">
      ...
      <main className="mx-auto w-full max-w-[1200px] px-8 py-10">
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          <aside className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-[var(--shadow-md)] transition-all hover:shadow-[var(--shadow-lg)]" style={{ minHeight: '90vh' }}>
